...
const about = () => {
    return (
        <>
            <Head>
                <title>About · Fernando Fine</title>
                <meta
                    name="description"
                    content="About Fernando Fine, cross-disciplinary design engineer."
                />
            ...
            <div className="space-y-6 mt-16 p-6 max-w-4xl mx-auto">
                ...
                <p>
                    I’m Fernando, an Oakland-born, Brooklyn-based cross
                ...
                <p>
                    ...
                    background forms the technical foundation for my design
                ...
                <p>
                    ...
                    and am always pursuing new creative tech projects. As a Bay
                    Area native and son of a political refugee, I’m interested
                    in fostering inclusive, international communities, having
                    volunteered as a mentor through Refugee and Immigrant
                    Transitions in San Francisco. Other hobbies include soccer,
                    League of Legends, woodworking, and hiking, and I am
                    currently trying (and failing) to learn to play cello.
                </p>
            </div>
        </>
    );
